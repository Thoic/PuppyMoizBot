...
import org.usfirst.frc.team31.robot.subsystems.DBLinkage;
...
import org.usfirst.frc.team31.robot.subsystems.NavX;
...
//	WPI_TalonSRX rightRearDrive = new WPI_TalonSRX(7);
	...
	public void teleopPeriodic() {
		...
		driveSystem.sendToDashboard();
		//System.out.println(driveSystem.navX.getAngle());
		
//		double leftFrontStickValue = driverStick.getRawAxis(1);
//		double leftBottomStickValue = driverStick.getRawAxis(1);
//		double rightFrontStickValue = driverStick.getRawAxis(1);
//		double rightBottomStickValue = driverStick.getRawAxis(1);
//		
//		leftFrontDrive.set(leftFrontStickValue);
//		leftMiddleDrive.set(leftFrontStickValue);
//		leftRearDrive.set(leftBottomStickValue);
//		
//
//		rightFrontDrive.set(rightFrontStickValue);
//		rightMiddleDrive.set(rightFrontStickValue);
//		rightRearDrive.set(rightBottomStickValue);
	}
